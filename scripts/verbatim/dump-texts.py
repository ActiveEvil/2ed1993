...
add("allowance", "army_list_allowance_rules", "note,qualifier,label", None, "note", "qualifier", "label")
add("allowance_set", "army_list_allowance_sets", "name,singular", "name", "name", "singular")
