...
export const _2ed1993: React.FC = (): React.JSX.Element => (
  <div className="relative aquilla-bars-sm flex flex-col justify-center items-center gap-8">
    <h1 className="inline-flex flex-col justify-center items-center px-4 border-2ed-light-yellow border-t-[8rem] border-x-[3rem] border-x-transparent font-title tracking-widest leading-0">
